		...
		<view class="fixbg" :style="{'background-image' : 'url('+playlist.coverImgUrl+')'}"></view>
			...
			<view class="container" v-show="!isLoading">
				<scroll-view scroll-y="true">
					...
					<!-- #ifdef MP-WEIXIN -->
					<button class="list-shaer" open-type="share">
					...
					<view class="list-music">
						...
						<view class="list-music-item" v-for="(item,index) in playlist.tracks" :key="index" @tap="headleToDetail(item.id)">
...
.list-head-img text{position: absolute;right: 8rpx;top: 8rpx;color: white;font-size: 22rpx;}
...
.list-head-text view:nth-child(3){line-height: 34rpx;font-size: 26rpx;}
.list-shaer{width: 330rpx;height: 74rpx;margin: 0 auto;background: rgba(0,0,0,.4);border-radius: 37rpx;color: white;text-align: center;line-height: 74rpx;font-size: 28rpx;}
.list-shaer text{margin-right: 16rpx;}
